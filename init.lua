...
local ensure_packer = function()
  ...
  if fn.empty(fn.glob(install_path)) > 0 then
    ...
    -- packer version commit -> ea0cc3c59f67c440c5ff0bbe4fb9420f4350b9a3
...
require("packer").startup(function(use)
  ...
  use { "fatih/vim-go", commit = "1401b576c6ac382529188d3d26cff866139f2f9a" }
  ...
  use {
    ...
    requires = { "nvim-tree/nvim-web-devicons", commit = "f0267921c845c42685968401bc49aa65e18d3e09" } -- Required  -- `bufferline` uses patched fonts, if want to see icons you must have a set of patched fonts installed and use `nvim-web-devicons` to map the fonts (default or custom)
    -- IMPORTANT: `nvim-web-devicons` requires a patched font to function on most terminals; see plugin configuration section for details
  }
  ...
  use { "folke/flash.nvim", commit = "48817af25f51c0590653bbc290866e4890fe1cbe" }
  ...
  use {
    ...
    requires = { "nvim-tree/nvim-web-devicons", commit = "f0267921c845c42685968401bc49aa65e18d3e09" }  -- Required  -- `nvim-tree` uses patched fonts, if want to see icons you must have a set of patched fonts installed and use `nvim-web-devicons` to map the fonts (default or custom)
    -- IMPORTANT: `nvim-web-devicons` requires a patched font to function on most terminals; see plugin configuration section for details
  }
